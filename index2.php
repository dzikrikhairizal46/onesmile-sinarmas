...
<body> 
  ...
  <!-- ======= Banner 1 Section ======= -->
  <div class="banner-area" data-aos="fade-in" data-aos-delay="100">
      <div class="container-fluid">
        <div class="header-area">
          <div class="header-content" data-aos="fade-out" data-aos-delay="300">
            <p>Track your product sales from anywhere, anytime.</p>
          </div> 
        </div>
      </div>
  </div>
  ...
  <!-- ======= Banner 2 Section ======= -->
  <div class="banner3-area">
    <div class="container-fluid">
      <div class="banner-featured-area">
        <div class="banner-featured-content">
          <strong>
            <span>Semua</span>
            <h1>Jadi Lebih Murah </h1>
            <h1><span>dengan</span> Loyalti Poin</h1>
          </strong>
          <h3>#pakaiOneSmile</h3>
