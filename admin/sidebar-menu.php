...
<ul class="sidebar-menu">
  ...
  // jika menu master data dipilih, menu master data aktif
  ...
  <li class="active treeview">
    ...
    <ul class="treeview-menu">
      ...
      <li><a href="?module=kategori"><i class="fa fa-circle-o"></i> Data Kategori</a></li>
    </ul>
  </li>
  <?php
  }
  ...
  // jika menu Kesekretariatan dipilih, menu Laporan Kesekretariatan aktif
  ...
  // jika menu Laporan finance Masuk dipilih, menu Laporan finance Masuk aktif
  elseif ($_GET["module"]=="lap") { ?>
  <li class="active treeview">
    <a href="javascript:void(0);">
  ...
  // jika menu Laporan tidak dipilih, menu Laporan finance tidak aktif
  else { ?>
  <li class="treeview">
    <a href="javascript:void(0);">
      <i class="fa fa-file-text"></i> <span>Finance</span> <i class="fa fa-angle-left pull-right"></i>
...
<ul class="sidebar-menu">
  ...
  // jika menu Master Data tidak dipilih, menu master data tidak aktif
  else { ?>
  <li class="active treeview">
    <a href="javascript:void(0);">
      <i class="fa fa-file-text"></i> <span>Master Data</span> <i class="fa fa-angle-left pull-right"></i>
...
// jika menu Kesekretariatan dipilih, menu kesekretariatan aktif
  if ($_GET["module"]=="lap_stok") { ?>
  <li class="active treeview">
    <a href="javascript:void(0);">
      <i class="fa fa-file-text"></i> <span>Kesekretariatan</span> <i class="fa fa-angle-left pull-right"></i>
  ...
  // jika menu Kesekretariatan Masuk dipilih, menu Kesekretariatan Masuk aktif
  elseif ($_GET["module"]=="lap_obat_masuk") { ?>
  <li class="active treeview">
    <a href="javascript:void(0);">
      <i class="fa fa-file-text"></i> <span>Kesekretariatan</span> <i class="fa fa-angle-left pull-right"></i>
  ...
  // jika menu Finance Masuk dipilih, menu Finance Masuk aktif
  elseif ($_GET["module"]=="lap") { ?>
  <li class="active treeview">
    <a href="javascript:void(0);">
      <i class="fa fa-file-text"></i> <span>Finance</span> <i class="fa fa-angle-left pull-right"></i>
