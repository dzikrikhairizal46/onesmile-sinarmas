...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            // perintah query untuk menyimpan data ke tabel event
            //print_r($query);
    ...
    elseif ($_GET['act']=='update') {
        if (isset($_POST['simpan'])) {
            ...
            $status  = mysqli_real_escape_string($mysqli, trim($_POST['status']));
                ...
                // perintah query untuk mengubah data pada tabel event
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            // perintah query untuk menghapus data pada tabel event
