...
<head>
  ...
  <title>Landing Page - OneSmile Sinarmas Land</title>
  ...
  <!-- Favicons -->
  <link href="assets/img/sinar-mas-land-logo-vektor.jpg" rel="icon">
            ...
            <div class="content d-flex flex-column justify-content-center">
              ...
              <div class="row">
                <div class="col-md-6 icon-box" data-aos="fade-up">
                  ...
                  <p>Fitur ini berisi detail tagihan air/IPL, Metode pembayaran, dan cara-cara pembayaran dari masing-masing channel.</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                  <img src="assets/img/icon-menu/market.png">
                  <h4><a href="#">Market</a></h4>
                  <p>Fitur ini berisi lapak dari warga (warga yang memiliki bisnis / Usaha).</p>
                </div>
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                  <img src="assets/img/icon-menu/community.png">
                  <h4><a href="#">Community</a></h4>
                  <p>Fitur ini berisi Group Cluster dan Group Komunitas <br><br>
                    <b>Cluster :</b><br>
                ...
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                  ...
                  <p>Fitur direct ke Customer Care<br>
                    <b>Live Chat</b><br>
                ...
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                  ...
                  <p>Berisi list nomor telepon / tempat-tempat penting berikut Directory di BSD City. (Rumah Sakit terdekat, PLN, Pemadam Kebakaran, Kantor Polisi, dan lainnya).<br><br>
        ...
        <div class="row no-gutters clients-wrap clearfix wow fadeInUp">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/cupten-cafe.png" class="img-fluid" alt="" data-aos="flip-right">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/dutch-boba.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="100">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/gion.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="200">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/honu.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="300">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/imoto-izakaya.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="400">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/jeruk-meletus.PNG" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="500">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/katsukita.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="100">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/kotomono.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="200">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/la-baia.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="300">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/lapan-pagi.PNG" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="400">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/leko.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="500">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/moji.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="100">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/fore.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="200">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/nasi-bali-men-sri.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="300">
            </div>
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <div class="client-logo">
              <img src="assets/img/No-background/wangfu-dimsum.png" class="img-fluid" alt="" data-aos="flip-right" data-aos-delay="400">
            </div>
          </div>
      ...
      <div class="content-area">
          <div class="content">
              <div class="row justify-content-center">
                ...
                <a href="https://play.google.com/store/apps/details?id=com.sinarmasland.onesmile">
                  <div class="download" data-aos="fade-up">
                    <i class="fab fa-google-play fa-2x"></i>
                    <span class="download-from">Download from</span>
                    <span class="app-store">Play Store</span>
                  </div>
                </a>
                <a href="https://apps.apple.com/id/app/one-smile-by-sinar-mas-land/id1551898065">
                  <div class="download" data-aos="fade-up">
                ...
                <a href="home.php">
                  <div class="info" data-aos="fade-up">
                    <span class="info-lengkap">Info Selengkapnya</span>
                  </div> 
                </a>
            </div>
          </div>
