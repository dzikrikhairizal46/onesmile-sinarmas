      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-5 pt-4" data-aos="fade-right">
            <img src="../../Aplikasi-Porta-Berita-Berbasis-Web/portal/admin/images/sub-artikel/<?php echo $sub_foto1;?>" class="img-fluid" alt="" width="400">
          </div>
        ...
        <div class="row content">
          <div class="col-md-5 order-1 order-md-2 pt-5" data-aos="fade-left">
            <img src="../../Aplikasi-Porta-Berita-Berbasis-Web/portal/admin/images/sub-artikel/<?php echo $sub_foto2;?>" class="img-fluid" alt="" width="400">
          </div>
        ...
        <div class="row content">
          <div class="col-md-5 pt-4" data-aos="fade-right">
            <img src="../../Aplikasi-Porta-Berita-Berbasis-Web/portal/admin/images/sub-artikel/<?php echo $sub_foto3;?>" class="img-fluid" alt="" width="400">
          </div>
          <div class="col-md-7 pt-4" data-aos="fade-left">
        ...
        <div class="row content">
          <div class="col-md-5 order-1 order-md-2 pt-5" data-aos="fade-left">
            <img src="../../Aplikasi-Porta-Berita-Berbasis-Web/portal/admin/images/sub-artikel/<?php echo $sub_foto4;?>" class="img-fluid" alt="" width="400">
          </div>
          <div class="col-md-7 pt-5 order-2 order-md-1" data-aos="fade-right">
        ...
        <div class="row content">
          <div class="col-md-5 pt-4" data-aos="fade-right">
            <img src="../../Aplikasi-Porta-Berita-Berbasis-Web/portal/admin/images/sub-artikel/<?php echo $sub_foto5;?>" class="img-fluid" alt="" width="400">
          </div>
          <div class="col-md-7 pt-4" data-aos="fade-left">
        ...
        <div class="row content">
          <div class="col-md-5 order-1 order-md-2 pt-5" data-aos="fade-left">
            <img src="../../Aplikasi-Porta-Berita-Berbasis-Web/portal/admin/images/sub-artikel/<?php echo $sub_foto6;?>" class="img-fluid" alt="" width="400">
          </div>
          <div class="col-md-7 pt-5 order-2 order-md-1" data-aos="fade-right">
